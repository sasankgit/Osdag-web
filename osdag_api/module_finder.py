from osdag_api.modules import base_plate_connection,beam_beam_end_plate_connection, fin_plate_connection,end_plate_connection,cleat_angle_connection,seated_angle_connection,cover_plate_bolted_connection, cover_plate_welded_connection, beam_column_end_plate,bolted_tension_member, simply_supported_beam
...
module_dict : Dict[str, ModuleApiType] = {
    ...
    'Base-Plate_Connection':base_plate_connection,
} 
