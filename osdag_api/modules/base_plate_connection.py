...
def generate_output(input_values: Dict[str, Any]) -> Dict[str, Any]:
    ...
    print("in fin_plate_connection.py:(test baseplate) Final output dict: ", output)
    print("in fin_plate_connection.py:(test baseplate) Output keys: ", list(output.keys()))
    print("in fin_plate_connection.py:(test baseplate) Returning logs: **********", logs)
    return output, logs
